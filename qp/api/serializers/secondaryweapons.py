...
from qp.warframe.models import qpSecondaryWeapon, qpSecondaryWeaponComponent, qpSecondaryWeaponRelicReward
...
class qpSecondaryWeaponComponentSimpleSerializer(serializers.ModelSerializer):
...
class qpSecondaryWeaponRelicRewardSimpleSerializer(serializers.ModelSerializer):
    is_owned = serializers.SerializerMethodField()
    component = qpSecondaryWeaponComponentSimpleSerializer()
    ...
    def get_is_owned(self, obj):
        try:
            ...
            if ("slug" in kwargs and user is not None) or ("slug" not in kwargs and user.is_authenticated):
                result = user.secondaryweapon_components.filter(
